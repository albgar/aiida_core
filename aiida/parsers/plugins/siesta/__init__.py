...
class SiestaParser(Parser):
    ...
    def _get_output_nodes(self, output_path, error_path, xml_path, bands_path):
        ...
        #I don't parse bands if bands_path is None
        #otherwise I call get_bands and I create the BandsData 
        #class bands_array
        if bands_path is None:
	    flagbands= False #useless, just to have a command here
	    #nothing to do...I was thinking to put a rimender here
            #like: "you are not calculating bands, are you aware of it?"
	else:
